...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.63-kirby-problem-4.63-08f97c01-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.63"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.63-kirby-problem-4.63-08f97c01-v1",
      "problem_contract_sha256": "1c302a75add872175f094b950c3afa7ba8b096725e542d7acb67c6f3ee1fcd32",
      "problem_id": "problem:um-kp-4.63-kirby-problem-4.63-08f97c01",
      "route_id": "route:um-kp-4.63-kirby-problem-4.63-08f97c01-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.63-kirby-problem-4.63-08f97c01-source-fidelity-01",
      "graph_id": "graph:um-kp-4.63-kirby-problem-4.63-08f97c01-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.63-kirby-problem-4.63-08f97c01-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.63-kirby-problem-4.63-08f97c01-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "How many independent basic classes can a simply connected smooth 4-manifold X have, as measured $bybr(X)$, the rank of the span of the basic classes? (a) Is there an upper bound $forbr(X)$ in terms of topological invariants of X? (b) In particular, is $br(X) \\leq b^{+}_{2}(X)$ for all simply connected X with $b^{+}_{2}(X)$ odd? (c) Is there a smooth indefinite, simply connected 4-manifold X with $b_{2}(X) \\geq$ 3 for which the image of $ev_{*}: \\operatorname{Diff}(X) \\to \\operatorname{Aut}(Q_{X})$ is finite, or even trivial?"
          },
          "statement_sha256": "6e65c9c4aca2f14e819e114c42771e5016fc7d6d1ab2aa359ab9952867f7aa4b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.63-kirby-problem-4.63-08f97c01-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.63-kirby-problem-4.63-08f97c01-root",
      "route_id": "route:um-kp-4.63-kirby-problem-4.63-08f97c01-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.63-cd00966fb245",
        "url": "https://www.unsolvedmath.com/problems/KP-4.63"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
